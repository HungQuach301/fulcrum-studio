...
## D-22 · Gói phát triển nhanh FS22-20260914 — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.

## D-23 — Gói FS23-WP001: bootstrap CI với quyền sửa–kiểm–thu gộp — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.

## D-24 — FS24-B: state identity, artifact transport and bounded integration — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.

## D-25 · FS24-B-R1 receipt diagnosis and repair bootstrap — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.

## D-26 · FS24-C — bounded successor integration — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.

## D-27 · FS24-D — owner-approved repair, recovery and acceptance — Toàn văn: `engine/docs/decisions/archive-fs2x.md`.
